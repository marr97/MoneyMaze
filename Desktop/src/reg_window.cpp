...
QString reg_window::get_new_login() const
{
  return user_newlogin;
}

QString reg_window::get_new_password() const
{
  return user_newpassword;
}

QString reg_window::get_confirmation() const
{
  return user_password_confirmation;
}

bool reg_window::check_password_confirmation() const
{
...
void reg_window::on_pushButton_create_account_clicked() {
  ...
  HttpClient::send_registration_data(regData);
  this->hide();
}

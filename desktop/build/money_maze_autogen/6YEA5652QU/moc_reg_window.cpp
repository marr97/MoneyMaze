...
static constexpr auto qt_meta_stringdata_ZN10reg_windowE = QtMocHelpers::stringData(
    "reg_window",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10reg_windowE[] = {
...
Q_CONSTINIT const QMetaObject reg_window::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10reg_windowE.offsetsAndSizes,
    qt_meta_data_ZN10reg_windowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10reg_windowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<reg_window, std::true_type>,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        // method 'on_lineEdit_confirmation_textEdited'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        // method 'on_pushButton_create_account_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void *reg_window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10reg_windowE.stringdata0))

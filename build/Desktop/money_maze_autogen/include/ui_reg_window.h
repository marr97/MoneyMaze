...
public:
    ...
    void setupUi(QDialog *reg_window)
    {
        ...
        palette7.setBrush(QPalette::ColorGroup::Active, QPalette::ColorRole::Base, brush5);
        palette7.setBrush(QPalette::ColorGroup::Inactive, QPalette::ColorRole::WindowText, brush5);
        palette7.setBrush(QPalette::ColorGroup::Inactive, QPalette::ColorRole::Base, brush5);

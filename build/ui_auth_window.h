...
public:
    ...
    void setupUi(QDialog *auth_window)
    {
        ...
        lineEdit_password->setCursor(QCursor(Qt::ArrowCursor));
        ...
        horizontalSpacer_2 = new QSpacerItem(50, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Minimum);
        ...
        lineEdit_login->setCursor(QCursor(Qt::ArrowCursor));
        ...
        horizontalSpacer_5 = new QSpacerItem(80, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Minimum);

        gridLayout_2->addItem(horizontalSpacer_5, 0, 0, 1, 1);

        horizontalSpacer_4 = new QSpacerItem(80, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Minimum);
        ...
        horizontalSpacer_7 = new QSpacerItem(80, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Minimum);

        gridLayout_3->addItem(horizontalSpacer_7, 0, 2, 1, 1);

        sign_in_pushButton = new QPushButton(gridLayoutWidget_2);
        sign_in_pushButton->setObjectName(QString::fromUtf8("sign_in_pushButton"));
